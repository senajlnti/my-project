...
<template>
    <Navbar>
      <template #logo>
        <NavbarLogo link="https://www.google.com/" alt="Flowbite logo" image-url="https://www.beautybrands.com/images/set_a/en_us/global/globalnav/logo_xs.png">
          
        </NavbarLogo>
      </template>
      <template #default="{isShowMenu}">
        <NavbarCollapse :isShowMenu="isShowMenu">
          <NavbarLink is-active><b>Home</b></NavbarLink>
          <NavbarLink><b>About</b></NavbarLink>
          <NavbarLink><b>Contact</b></NavbarLink>
        </NavbarCollapse>
      </template>
      <template #right-side>
